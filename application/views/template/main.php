                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box" style="border-bottom: 2px solid #f0fece;">
                        <a href="<?= base_url() ?>" target="_blank" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?= data_sistem('logo') ?>" alt="image" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="<?= data_sistem('logo') ?>" alt="image" height="40">
                            </span>
                        </a>
                        ...
                        <a href="<?= base_url() ?>" target="_blank" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="<?= data_sistem('logo') ?>" style="border:1px solid #fff;border-radius: 50%;" alt="image" height="40">
                                <span class="ml-2 bold text-white fw-600"><?= data_sistem('nickname') ?></span>
                            </span>
                        </a>
                    </div>
        ...
        <div id="modal_custom_size" class="modal-dialog modal-xl">
            <div style="border: 0;" class="modal-content shadow1">
                <div class="modal-header bg1">
                    <h5 class="modal-title mt-0 text1 fw-600">JUDUL</h5>
